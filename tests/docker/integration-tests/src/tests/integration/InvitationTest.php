...
class InvitationTest extends TestCase
{
    ...
    private const NC_1_OCS_ROOT = "https://nc-1.nl/ocs/v2.php/collaboration";
    private const NC_1_APP_ROOT = "https://nc-1.nl/apps/collaboration";
    private const NC_2_COLLABORATION_SERVICE_PROVIDER_ENDPOINT = "https://nc-2.nl/apps/collaboration";
    ...
    public function setUp(): void
    {
        ...
        print_r("Received auth token: {$this->authToken} \n");
    ...
    //         $url,
    //         [
    //             "recipientProvider" => self::NC_2_COLLABORATION_SERVICE_PROVIDER_ENDPOINT,
