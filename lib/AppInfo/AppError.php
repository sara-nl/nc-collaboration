...
class AppError
{
    ...
    public const COLLABORATION_SERVICE_PROVIDER_NOT_FOUND = "COLLABORATION_SERVICE_PROVIDER_NOT_FOUND";
    public const COLLABORATION_SERVICE_PROVIDER_SERVICES_ERROR = "COLLABORATION_SERVICE_PROVIDER_SERVICES_ERROR";

    public const MESH_REGISTRY_PROVIDERS_ERROR = 'MESH_REGISTRY_PROVIDERS_ERROR';
